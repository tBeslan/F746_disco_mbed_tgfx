...
public:
     ...
     */
    STM32F7HAL(touchgfx::DMA_Interface& dma, touchgfx::LCD& display, touchgfx::TouchController& tc, uint16_t width, uint16_t height)
...
protected:
    ...
    static void DMA2D_IRQHandler(void);
