...
/**
 * @class STM32F7DMA STM32F7DMA.hpp platform/hal/ST/mcu/stm32f7xx/STM32F7DMA.hpp
 *
 * @brief This class specializes DMA_Interface for the ST F7xx processors.
 *
 *        This class specializes DMA_Interface for the ST F7xx processors.
 *
...
public:
    ...
    /**
     * @fn void STM32F7DMA::setDeadTime(uint8_t dt)
     *
...
protected:
    ...
    /**
     * @fn virtual void STM32F7DMA::setupFillWithAlpha(const touchgfx::BlitOp& blitOp);
     *
